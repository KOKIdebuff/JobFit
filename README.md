...
> 以真人面试前的 AI 招聘能力验证为核心，并衔接后续真人面试的招聘辅助决策平台。
...
在 HR 基于完整上游评估结果决定候选人进入真人面试后，P1 规划由 HR 发送绑定岗位申请的正式面试预约链接。候选人登录对应账号后，通过链接查看指定主面试官的可用时间，自助选择线上或线下面试时间段；系统锁定时间并发送已维护的会议链接或线下地点邀请。该能力不进入当前 P0、3-4 周里程碑或比赛演示主流程，也不替代 AI 模拟面试、岗位能力试炼、AI 证据链报告或企业最终招聘决策。

支付、录制、外部日历、邮件通知、报告导出、企业管理员、多轮面试、平台真人服务等均属于后续规划能力，不属于当前 P0 或 P1 首期基础预约闭环；详细边界以 PRD 第 12 章为主源。
...
flowchart LR
  ...
  R --> D["HR 复核并作出人工决策"]
  D --> G["求职者查看成长反馈"]
  D -.->|"P1：HR 发送预约链接"| B["候选人自助预约企业真人面试"]
```
...
9. P1 规划在“进入真人面试”决定后，由 HR 发送绑定申请的预约链接，候选人登录后自助选择指定主面试官的可用时间；当前版本不实现该步骤。
